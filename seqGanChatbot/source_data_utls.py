...
def convert_seq2seq_files(questions, answers, TESTSET_SIZE):
    # 创建文件
    train_enc = open(conf.source_data_utils.train_enc, encoding='utf-8', mode='w')  # 问
    train_dec = open(conf.source_data_utils.train_dec, encoding='utf-8', mode='w')  # 答
    test_enc = open(conf.source_data_utils.test_enc, encoding='utf-8', mode='w')  # 问
    test_dec = open(conf.source_data_utils.test_dec, encoding='utf-8', mode='w')  # 答
